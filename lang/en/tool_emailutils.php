...
$string['block_bouncethreshold'] = 'Block emails over bounce threshold';
$string['block_bouncethreshold_desc'] = 'If enabled, emails to users will be blocked by the tool_emailutils plugin. This will work without enabling core bouncehandling.';
...
$string['blockbouncethreshold'] = 'User has exceeded bounce threshold';
